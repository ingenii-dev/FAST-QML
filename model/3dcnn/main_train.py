...
parser.add_argument("--checkpoint-iter", type=int,
                    default=50, help="checkpoint save rate")
...
def train():
    ...
    for epoch_ind in range(epoch_start, args.epoch_count):
        ...
        for batch_ind, batch in enumerate(dataloader):
            ...
            print("[%d/%d-%d/%d] training, loss: %.3f, lr: %.7f" % (epoch_ind+1, args.epoch_count,
                  batch_ind+1, batch_count, loss.cpu().data.item(), optimizer.param_groups[0]['lr']))
